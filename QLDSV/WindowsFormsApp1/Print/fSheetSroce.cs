...
{
    public partial class fSheetSroce : Form
    {
        public fSheetSroce()
        {
            InitializeComponent();
        ...
        //đưa dữ liệu vào cb Mã sinh viên
        ...
        private void fSheetSroce_Load(object sender, EventArgs e)
        {
            loadComboboxTenLop();
        }
        ...
        DataTable MakeDataTable()
        {
            ...
            //tạo datatable
            conn.Open();
            String sqlSELECT = "SELECT d.MASV,m.TENMH,d.DIEM FROM Diem d,MonHoc m where m.MAMH = d.MAMH";
            ...
            string stringExpression = "MASV = '" + cbMaSV.Text + "'";
        ...
        private void btnPrintSheetSroce_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtbl = MakeDataTable();
                ExportDataTableToPdf(dtbl, @"F:\HK1-2019-2020\CSDLPT\Đồ án\pdf file\PhieuDiem.pdf", "PHIEU DIEM");
                // Hiển thị file pdf
                System.Diagnostics.Process.Start(@"F:\HK1-2019-2020\CSDLPT\Đồ án\pdf file\PhieuDiem.pdf");
